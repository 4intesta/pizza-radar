...
# Page Definitions
# ---------------------------------------
p1 = st.Page("pages/panoramica/competition.py", title="Pizzerie in zona", icon=":material/local_pizza:", url_path="pizzerie-in-zona")
p7 = st.Page("pages/panoramica/trending.py", title="Temi di tendenza", icon=":material/trending_up:", url_path="temi-di-tendenza")
